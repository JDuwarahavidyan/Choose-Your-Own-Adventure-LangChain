...
class Story(Base):
    ...
    id = Column(Integer, primary_key=True, index=True) # Index makes it faster to search by id, rather than scanning the each row it directly goes to the row with that id.
